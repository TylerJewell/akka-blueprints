...
|---|---|---|---|---|
| POST | `/api/tickets` | `{ "subject": "string", "body": "string" }` | `{ "ticketId": "uuid" }` | SupportEndpoint → SupportWorkflow |
| POST | `/api/tickets/{ticketId}/approve` | `{ "approvedBy": "string", "note": "string" }` | `200` \| `404` | SupportEndpoint → TicketEntity |
| POST | `/api/tickets/{ticketId}/escalate` | `{ "escalatedBy": "string", "reason": "string" }` | `200` \| `404` | SupportEndpoint → TicketEntity |
...
```json
{
  ...
  "body": "string or null",
  "status": "TRIAGED | APPROVED | ESCALATED | RESOLVED",
  "submittedAt": "ISO-8601 or null",
  "triageCategory": "billing | technical | account | general | null",
  "triagePriority": "low | medium | high | null",
  "triageSummary": "string or null",
  "approvedAt": "ISO-8601 or null",
  "approvedBy": "string or null",
  "operatorNote": "string or null",
  "escalatedAt": "ISO-8601 or null",
  "escalatedBy": "string or null",
